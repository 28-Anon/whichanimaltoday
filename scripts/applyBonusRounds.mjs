...
const ROUNDS = {
  ...
  Narwhal: { q: "One of these is true. Which?", a: "My 'horn' is really a tooth that grew out through my lip", d: ["I use it to spear fish", "I shed it and grow a new one each year", "Only the females grow one"] },
  ...
  Koala: { q: "One of these is true. Which?", a: "My fingerprints are so like yours they've confused crime scenes", d: ["I'm a kind of bear", "I drink several litres of water a day", "I hunt at night"] },
